module.exports = app => {
  ...
  /**
    ...
    * @apiSuccess {Object[]} task Task's list
    * @apiSuccess {Number} tasks.id Task id
    * @apiSuccess {String} tasks.title Task title
    * @apiSuccess {Boolean} tasks.done Task is done?
    * @apiSuccess {Date} tasks.updated_at Updates date
    * @apiSuccess {Date} tasks.created_at Registers date
  ...
  */
  ...
  /**
    ...
    * @apiSuccess {Boolean} done=false Task  is donde?
    * @apiSuccess {Date} updated_at Updates date
    * @apiSuccess {Date} created_at Registers date
  ...
  */
  ...
  app.route("/tasks/:id")
    ...
    /**
      ...
      * @apiSuccess {Date} updated_at Updates date
      * @apiSuccess {Date} user_id User id
      * @apiSuccessExample {json} Success
      *   HTTP/1.1 200 OK
      *   {
      *     "id": 1,
